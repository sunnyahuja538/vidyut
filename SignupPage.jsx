    ...
    <div className={styles.bg1}>
        ...
        <div className={styles.login}>
            <div className={styles.nav}>
                ...
                <p className={styles.para}>Already have an account?<p className={styles.para1}>Login</p></p>
            </div>
            <div className={styles.bigBox}>
            <div className={styles.inputSection}>
                <input type="text" className={styles.isInput2} placeholder="FullName"/><br />
                <input type="text" className={styles.isInput2} placeholder="Username"/><br/>
                <input type="password" className={styles.isInput2} placeholder="Password"/><br/>
                <input type="password" className={styles.isInput2} placeholder="ConfirmPassword"/>
                <div className={styles.log}>
                <select className={styles.smBtn} >
                    <option>SignUp as User</option>
                    <option>SignUp as Employee</option>
                </select><br/>
                <button className={styles.smBtn6}>SignUp With Google<span><img src={google} /></span> </button>
                </div>
            </div>
            </div>
        </div>
